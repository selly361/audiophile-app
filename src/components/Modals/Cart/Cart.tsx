...
import { CheckoutLink, TotalPrice, TotalText, CartTotal, Price, Name, Item, ItemContainer, ItemsContainer, CartImage, RemoveAllButton, CartLength, CartHeader, Wrapper, Container } from "./cart-styles.ts"
